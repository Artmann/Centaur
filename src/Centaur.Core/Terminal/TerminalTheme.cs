...
public class TerminalTheme
{
    ...
    public TerminalTheme(uint foreground, uint background, uint cursor, uint selection, uint[] palette)
    {
    ...
    public uint GetColor(int index) => index >= 0 && index < FullPalette.Length ? FullPalette[index] : Foreground;
}

public static class CatppuccinThemes
{
    public static TerminalTheme Latte { get; } = new(
    ...
    public static TerminalTheme Frappe { get; } = new(
    ...
    public static TerminalTheme Macchiato { get; } = new(
    ...
    public static TerminalTheme Mocha { get; } = new(
